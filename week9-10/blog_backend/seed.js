...
const blogPostsData = [
    ...
    },
    {
        ...
        article_photo: "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800&h=600&fit=crop",
        featured: false,
        status: "published",
...
const categories = [
  "Technology", "Web Development", "JavaScript", "Svelte", "Frontend", "Backend",
  "DevOps", "AI & Machine Learning", "Data Science", "Productivity", "Career",
  "Startups", "Entrepreneurship", "Remote Work", "Personal Development",
  "Self-Improvement", "Minimalism", "Finance", "Investing", "Crypto & Blockchain",
  "Travel", "Digital Nomad", "Food & Cooking", "Health & Fitness", "Mental Health",
  "Books & Reading", "Writing", "Design", "UI/UX", "Photography", "Parenting",
  "Relationships", "Lifestyle", "Sustainability", "Environment", "Science",
  "Wellness", "Business", "Psychology", "Cybersecurity", "Food", "Health", "Ethics"
];
const Tags = [
  "JavaScript","TypeScript","Svelte","SvelteKit","React","Vue","Node.js","Python",
  "Docker","AWS","Tailwind CSS","Frontend","Backend","Full-Stack","Web Performance",
  "Accessibility","SEO","Jamstack","Serverless","GraphQL","Open Source","GitHub",
  "Productivity","Notion","Remote Work","Digital Nomad","Career Advice","Freelancing",
  "Startups","SaaS","AI","ChatGPT","Machine Learning","Finance","Investing","Crypto",
  "Blockchain","Web3","Travel","Minimalism","Mental Health","Mindfulness","Fitness",
  "Cooking","Vegan","Books","Writing","Design","Figma","Photography","Parenting",
  "Sustainability","Climate Change","Zero Waste","IoT","Security","DeFi","6G"
];
  ...
  try {
    ...
    for (const post of blogPostsData) {
      if (!usersMap[post.author.name]) {
        let user = await User.findOne({ username: post.author.name.toLowerCase().replace(/\s+/g, '_') });
        if (!user) {
