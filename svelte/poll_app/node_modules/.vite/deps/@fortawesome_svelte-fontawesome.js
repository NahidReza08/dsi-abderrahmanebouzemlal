...
import {
  ...
  prop,
  spread_props
} from "./chunk-W6ECXQLF.js";
import "./chunk-U7P2NEEE.js";
import {
  append,
  comment,
  from_svg
} from "./chunk-G3F6MKX7.js";
import {
  FILENAME,
  HMR,
  add_svelte_meta,
...
function convert(createElement2, element, extraProps = {}) {
  ...
  const children = (element.children || []).map((child2) => {
    return convert(createElement2, child2);
  });
...
function familyProxy(obj) {
  return new Proxy(obj, {
    get: function get3(target, prop2) {
      return prop2 in target ? target[prop2] : target[i];
    }
  });
}
...
function normalizeIconArgs(icon3) {
  if (icon3 && typeof icon3 === "object" && icon3.prefix && icon3.iconName && icon3.icon) {
    return icon3;
  }
  if (parse$1.icon) {
  ...
  if (icon3 && typeof icon3 === "object" && icon3.prefix && icon3.iconName) {
    return icon3;
  }
  if (Array.isArray(icon3) && icon3.length === 2) {
    return { prefix: icon3[0], iconName: icon3[1] };
  }
  if (typeof icon3 === "string") {
    return { prefix: "fas", iconName: icon3 };
  }
}
...
function FontAwesomeIcon($$anchor, $$props) {
  ...
  let icon3 = prop($$props, "icon", 8, null);
  ...
  let ref = prop($$props, "ref", 12, null);
  let style = prop($$props, "style", 8, null);
  const iconLookup = normalizeIconArgs(icon3());
