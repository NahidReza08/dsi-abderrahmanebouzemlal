...
export const projects = [
  {
    ...
    description:
      'A pomodoro timer integrated with a todo list, built with Svelte and styled using Tailwind CSS.',
    category: 'Todo',
  ...
  },
  {
    ...
    description:
      'A responsive landing page for a fictional cloud storage service, designed with Tailwind CSS.',
  ...
  },
  {
    ...
    description:
      'A sleek and modern blog post layout with a focus on readability, created using Tailwind CSS.',
    category: 'blog',
  ...
  },
  {
    ...
    description:
      'A clean and professional landing page for a digital banking service, built with Tailwind CSS.',
    category: 'landing page',
  ...
  },
  {
    ...
    description:
      'A testimonial section featuring user reviews in a responsive grid layout, styled with Tailwind CSS.',
    category: 'grid',
  ...
  },
  {
    ...
    description:
      'A job listing interface with dynamic filtering options, built using Svelte and Tailwind CSS.',
